...
public class Main {
    ...
    public static void main(String[] args) throws VariableWasNotInitializedException {
        OwnerActionOfTVStudio ownerOfTelevisionStudio = new OwnerActionOfTVStudio("Owner Of TV Studio");
        ...
        Hotel emeraldHotel = new Hotel("Изумруд", mrHaps, 1);
        ...
        } catch (VariableWasNotInitializedException e){
            System.out.println("Количество жильцов в отеле неизвестно, поэтому невозможно заселить новых.");
        }
